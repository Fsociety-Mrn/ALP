...
CALC_MULTIPLICATION_CHOOSE_BASE proc
...
; pang clear screeen
        ...
        mov ah,09h
        lea dx,menu231  ; ==== MULTIPLICATION BASE 03 =====
        int 21h
...
; first input
		...
		cmp [inputA1],'2'
		jg MUL_BASE3	   			; reject input higher than 5| NOTE : NIREKTA BALIK KO SA FUNCTION
